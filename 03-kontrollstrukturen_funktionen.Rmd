...
Wie wir schon bei der Funktion `sqrt()` in Abschnitt \ref{sec:vektoren} gesehen haben, wird nun die Funktion elementweise angewandt und als Ergebnis wird ein Vektor gleicher Länge zurückgegeben.
