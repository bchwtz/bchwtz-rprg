...
```{r}
Sys.getenv("WEBDAV_USERNAME")
Sys.getenv("WEBDAV_USER")
```
...
#fhswf_list_submissions(url = "https://fh-swf.sciebo.de/public.php/webdav/", 
#                       part = "EX2")

url <- "https://fh-swf.sciebo.de/public.php/webdav/"
l <- lapply(c("EX1", "EX2", "EX3"), fhswf_list_submissions, url=url)


bind_rows(l) %>% kbl() %>% kable_styling()
