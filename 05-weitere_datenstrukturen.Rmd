...
Mithilfe der Funktion `table()` (siehe Übungen zu Kapitel \@ref(homogenedatenstrukturen), Abschnitt \@ref(chap4uebungen)) kann ein Faktor auch in Tabellenform angezeigt werden:
```{r}
table(f1)
```
...
In den Übungen zu Kapitel \@ref(homogenedatenstrukturen) (siehe Abschnitt \@ref(chap4uebungen)) haben wir bereits die Funktion `order()` kennengelernt.
