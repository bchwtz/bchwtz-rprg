...
```{r, echo=FALSE, fig.cap="(ref:figlist-vektor-1)", out.width="100%"}
...
```{r, echo=FALSE, fig.cap="(ref:figlist-vektor-2)", out.width="100%"}
...
```{r, echo=FALSE, fig.cap="(ref:figlist-vektor-3)", out.width="100%"}
...
```{r, echo=FALSE, fig.cap="(ref:figlist-vektor-4)", out.width="100%"}
