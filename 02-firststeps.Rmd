...
```{r abb-debug1, echo=FALSE, fig.cap="(ref:debug-browser)", out.width="60%"}
...
```{r abb-debug2, echo=FALSE, fig.cap="(ref:debug-browser2)", out.width="60%"}
...
```{r abb-debug3, echo=FALSE, fig.cap="(ref:debug-browser3)", out.width="60%"}
