...
Für einige mag das Problem bei diesem Code vielleicht sofort offensichtlich gewesen sein. Liegt Ihnen jedoch ein viel umfangreicherer Code vor, so ist dieses Problem nicht sofort offensichtlich und *Debugging* ist nicht mehr wegzudenken.

Soll das *Debugging* beendet werden, kann entweder auf *Stop* (siehe Abbildung \@ref(abb-debug2)) geklickt oder die `Esc` genutzt werden.
